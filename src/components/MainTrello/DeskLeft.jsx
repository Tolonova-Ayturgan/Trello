...
import ModalDeskLeft from "../modalWindow/ModalDeskLeft";
...
const DeskLeft = () => {
  ...
  return (
    <div>
      <StyleDiv>
            <div style={{ width: "35px", height: "35px", background: "aqua", fontWeight: "800", borderRadius: "3px", margin: "auto"}}>P</div> 
        <div
          style={{
            display: "flex",
        ...
        >  
          ...
          <StyleP>Trello</StyleP>
          <StyleP>Бесплатно</StyleP>
        </div>
        <Button style={{background: "#161A1D"}}><MdKeyboardArrowLeft style={{fontSize: "25px", color: "white"}}/></Button>
      </StyleDiv>
      <StyleDiv2>
        <div style={{ borderTop: "1px solid #9fadbc78" }}>
          <StyleMain>
            <StyleMainSvg
              width="16"
              height="16"
          ...
          <StyleMain>
            ...
            <div style={{ display: "flex", alignItems: "center" }}>
              <StyleMainP>Участники</StyleMainP> 
             <Button  style={{color: "#9FADBC", fontSize: "28px",marginLeft: "107px"}}>+</Button> 
            </div>
          </StyleMain>
          <StyleMain>
            <StyleMainSvg
...
const StyleDiv = styled.div`
  ...
  min-height: 40px;
  border: 1px solid #9fadbc78;
  border-bottom: 1px solid var(--dynamic-text-transparent);
`;
const StyleAdmin = styled.div`
  background: linear-gradient(
    var(--ds-background-accent-red-bolder, #CC4223),
    var(--ds-background-accent-orange-subtle, #CB7D25)
  );
  display: flex;
  align-items: center;
...
const StyleMain = styled.div`
  ...
  margin: 5px 0 0 12px;
`;
const StyleMainSvg = styled.svg`
  color: #9FADBC;
`;
const StyleMainP = styled.p`
  text-align: start;
  color: #9FADBC;
  margin: 0 0 0 12px;
  overflow: hidden;
